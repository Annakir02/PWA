 ...
 */
namespace Yereone\Testimonial\Ui\Component\Listing\Column;
...
class TestimonialActions extends Column
{
    ...
    const URL_PATH_DETAILS = 'testimonial/testimonial/details';
        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as & $item) {
                if (isset($item['testimonial_id'])) {
                    $title = $this->getEscaper()->escapeHtmlAttr($item['image']);
