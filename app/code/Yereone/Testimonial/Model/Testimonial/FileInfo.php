<?php
namespace Yereone\Testimonial\Model\Testimonial;
...
class FileInfo
{
     ...
     */
    const ENTITY_MEDIA_PATH = 'yereone/image/testimonial';
    ...
    private function getFilePath($fileName)
    {
        ...
        // if the file is not using a relative path, it resides in the yereone/image media directory
