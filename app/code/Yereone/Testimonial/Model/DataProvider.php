...
use Yereone\Testimonial\Model\ResourceModel\Testimonial\CollectionFactory;
use Magento\Framework\App\Request\DataPersistorInterface;
use Magento\Ui\DataProvider\Modifier\PoolInterface;
use Yereone\Testimonial\Api\TestimonialRepositoryInterface;
use Yereone\Testimonial\Model\Testimonial\FileInfo;
...
class DataProvider extends \Magento\Ui\DataProvider\ModifierPoolDataProvider
{
    ...
    public function getData()
    {
        ...
        if($testimonialId) {
            $item = $this->testimonialRepository->getById($testimonialId);
